...
cmd:option("-snapshot_dir", "./snapshot_fine_tune_some_real_over_all_shynt_no_IR/", "snapshot directory")
cmd:option("-snapshot_epoch", 5, "snapshot after how many iterations?")
cmd:option("-gpu", true, "use gpu")
cmd:option("-weights", "snapshot_train_synthetic/snapshot_epoch_100.net", "pretrained model to begin training from")
cmd:option("-log", "output_snapshot_fine_tune_some_real_over_all_shynt_no_IR")
